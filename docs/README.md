...
Start with [Install](./install.md) and [Getting started](./getting-started.md) if you are trying `scout` for the first time.

## Guides

| Page                                    | Purpose                                                                 |
| --------------------------------------- | ----------------------------------------------------------------------- |
| [Install](./install.md)                 | Build the binary, install locally, and verify the CLI.                 |
| [Getting started](./getting-started.md) | Run the first index, choose output formats, write managed blocks, and troubleshoot first runs. |
